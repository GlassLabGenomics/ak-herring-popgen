...
#SBATCH --output=/scratch/letimm/bering-sea-herring/job_outfiles/CPAL-CPAL260-GOA-UN-EBS-KOTZ_filtered_unlinked_plm_gls_%A-%a.out
...
PREFIX=CPAL-CPAL260-GOA-UN-EBS-KOTZ
REF_FASTA=/scratch/letimm/reference_genomes/Clupal_KotzSound_assembly.fasta
BAMSLIST_FILE=${BASEDIR}/${PREFIX}_bamslist.txt
