...
#SBATCH --output=/scratch/letimm/bering-sea-herring/job_outfiles/CPAL-CPAL260-EBS_filtered_plm_gls_%A-%a.out
...
angsd \
	...
	-r ${chrom} \
	-sites ${SITES_FILE} \
	-out ${BEAGLE_DIR}/${PREFIX}_${chrom}_filtered_plm_gls \
