...
#SBATCH --mem=16G
#SBATCH --job-name=pca7
#SBATCH --output=/scratch/letimm/Clupea_pallasii260/job_outfiles/CPAL-CPAL260-sv_chr7_pca_%A.out
...
#chr7-1
PREFIX1=CPAL-CPAL260-sv_chr7-1
pcangsd \
...
#chr7-2
PREFIX2=CPAL-CPAL260-sv_chr7-2
pcangsd \
