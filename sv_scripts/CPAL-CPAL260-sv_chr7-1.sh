...
#SBATCH --mem=32G
#SBATCH --job-name=chr7-1
#SBATCH --output=/scratch/letimm/Clupea_pallasii260/job_outfiles/CPAL-CPAL260-sv_chr7-1_%A.out
...
angsd \
	...
	-r Clupal_KotzSound_chrom07:1-20986379 \
	-out /scratch/letimm/Clupea_pallasii260/structural_variants/gls/CPAL-CPAL260-sv_chr7-1 \
